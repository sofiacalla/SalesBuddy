...
const generateTransactions = (count: number): Transaction[] => {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const amount = Math.floor(Math.random() * 15000) / 100 + 5; // 5.00 to 155.00
...
export const BUDGETS: BudgetCategory[] = [
  ...
  { id: "cat-5", name: "Shopping", allocated: 500, spent: 620, color: "hsl(346.8 77.2% 49.8%)" }, // Over budget
];
